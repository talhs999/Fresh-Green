...
const VISIBLE = 1; // show 1 at a time
    ...
    <section className="py-20 md:pt-28 md:pb-12 bg-brand-dark overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        ...
        <div className="relative max-w-[450px] mx-auto">
          ...
          <button
            onClick={prev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-6 md:-translate-x-16 z-20 w-12 h-12 rounded-full bg-brand-accent text-brand-dark flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
            aria-label="Previous"
          >
          ...
          <button
            onClick={next}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-6 md:translate-x-16 z-20 w-12 h-12 rounded-full bg-brand-accent text-brand-dark flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
            aria-label="Next"
          >
